...
module.exports = {
     ...
     */
    getRepoName: function (buildConfig) {
        var projectRoot = buildConfig.projectRoot;
        var packageFile = path.join(projectRoot, 'package.json');

        var url = require(packageFile).repository.url;
     ...
     */
    getRepoUserName: function (buildConfig) {
        var repo = this.getRepoName(buildConfig);
     ...
     */
    isESlintSupported: function (buildConfig) {
