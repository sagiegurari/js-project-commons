...
if (process.env.CI && !process.env.GITHUB_ACTIONS) {
    coverageTasks.push('coveralls:full');
}

const dependenciesValidations = [];
/*istanbul ignore next*/
if (process.env.DEPENDENCY_CHECKS) {
    dependenciesValidations.push('versioncheck');
}
...
module.exports = function (grunt) {
    ...
    grunt.registerTask('dependenciesValidations', 'Runs validations for project dependencies.', dependenciesValidations);
    ...
    grunt.registerTask('coverage-ci', 'Test for continues integration.', coverageTasks);
